...
- Jira 상태 변경 즉시 확인 가능
- QA–개발 간 커뮤니케이션 대기 시간 감소
- 기존 수동 확인 방식 → 실시간 알림 방식으로 전환
- QA 업무 효율성 향상
...
- 상세 내용은 아래 문서를 참고해주세요.
  ...
  \- [jira 웹훅 메시지 멘트 초안](https://github.com/Kwon-Giil/QA/blob/master/Jira/jira-webhook/jira%20웹훅%20메시지%20멘트%20초안.txt)

  \- [Jira 웹훅 알림 서비스 결과 보고서](https://github.com/Kwon-Giil/QA/blob/master/Jira/jira-webhook/Jira%20웹훅%20알림%20서비스%20결과%20보고서.pdf)
...
([지라 웹훅 결과물](https://github.com/Kwon-Giil/QA/blob/master/Jira/jira-webhook/지라%20웹훅%20결과물.png))
